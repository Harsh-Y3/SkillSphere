    ...
    <div>
        <nav className="z-10 fixed top-[-50px] left-0 right-0 h-36 flex justify-between items-center p-4 bg-blue-950 bg-opacity-40 ">
          ...
          <ul className="hidden md:flex space-x-6 text-lg gap-10 pt-10" >
            <li className="text-white hover:text-yellow-500 cursor-pointer">Home</li>
            <li className="text-white hover:text-yellow-500 cursor-pointer">About Us</li>
            <li className="text-white hover:text-yellow-500 cursor-pointer">Shop</li>
            <li className="text-white hover:text-yellow-500 cursor-pointer">Blogs</li>
            <li className="text-white hover:text-yellow-500 cursor-pointer">Contact</li>
          </ul>
          <div
           className='items-end '>
            <Link
